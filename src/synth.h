// Yes, this acts as a header. Fuck that.
...
//ICONST uint8_t song[SONGLEN * VOICES] = {
ICONST uint8_t song[] = {
	// surr
	0, 0,
	0, 0, 0, 0,
...
// vol, Q, F
ICONST int16_t instruments[(VOICES - 1) * INSTR_LEN] = {
	32000, 10000, 9000,
	26000, 22000, 7000,
};

IFUNCTION void writeaudio(void) {
	// These do something
	int v, i, row, s, k;
	// Dual saw osc state
	int osc1 = 0;
